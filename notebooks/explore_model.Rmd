...
multicollinearity? need to truncate output. i can keep a table of all the coefficients somewhere else
...
opposite results? filerate is a significant coefficients, but TSS and RSS are quite high and somehow adj r-sq is negative lol???
...
From these models (aside from plm--need to further investigate), I conclude that rate of eviction filings does not significantly affect the rate of homelessness in a state.
